...
{
    public partial class OdemeMasa5 : Form
    {
        List<tbl_Masa5> list;
        int fiyat = 0;
        public OdemeMasa5()
        ...
        private void sil()
        {
            var all = from c in db.tbl_Masa5 select c;
            db.tbl_Masa5.RemoveRange(all);
            db.SaveChanges();
            Goster();
            toplamFiyat();
        }
        ...
        private void OdemeMasa5_Load(object sender, EventArgs e)
        {
            Goster();
            toplamFiyat();
