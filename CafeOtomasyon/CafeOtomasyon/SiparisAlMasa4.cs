...
{
    public partial class SiparisAlMasa4 : Form
    {
        List<tbl_Masa4> list;
        public SiparisAlMasa4()
        {
            InitializeComponent();
        }
        ...
        private void SiparisAlMasa4_Load(object sender, EventArgs e)
        {
            YemekAdiGoster();
            Goster();
            toplamFiyat();
        ...
        private void btnSiparisSil_Click(object sender, EventArgs e)
        {
            ...
            var sonuc = db.tbl_Masa4.Where(x => x.id == kod).FirstOrDefault();
            id = sonuc.id;
            if (txtId.Text == "")
            {
                MessageBox.Show("Eksik Bilgi Girdiniz.");
