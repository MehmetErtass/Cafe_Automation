...
{
    public partial class SiparisAlMasa2 : Form
    {
        List<tbl_Masa2> list;
        public SiparisAlMasa2()
        {
            InitializeComponent();
        }
        ...
        private void btnSiparisSil_Click(object sender, EventArgs e)
        {
            ...
            var sonuc = db.tbl_Masa2.Where(x => x.id == kod).FirstOrDefault();
            id = sonuc.id;
            if (txtId.Text == "")
            {
                MessageBox.Show("Eksik Bilgi Girdiniz.");
        ...
        private void SiparisAlMasa2_Load(object sender, EventArgs e)
        {
            YemekAdiGoster();
            Goster();
            toplamFiyat();
