...
{
    public partial class OdemeMasa7 : Form
    {
        List<tbl_Masa7> list;
        int fiyat = 0;
        public OdemeMasa7()
        ...
        private void sil()
        {
            var all = from c in db.tbl_Masa7 select c;
            db.tbl_Masa7.RemoveRange(all);
            db.SaveChanges();
            Goster();
            toplamFiyat();
        }
        ...
        private void OdemeMasa7_Load(object sender, EventArgs e)
        {
            Goster();
            toplamFiyat();
