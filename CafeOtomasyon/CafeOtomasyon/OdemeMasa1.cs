...
{
    public partial class OdemeMasa1 : Form
    {
        List<tbl_Masa1> list;
        int fiyat = 0;
        public OdemeMasa1()
        ...
        private void OdemeMasa1_Load(object sender, EventArgs e)
        {
            Goster();
            toplamFiyat();
        ...
        private void sil()
        {
            var all = from c in db.tbl_Masa1 select c;
            db.tbl_Masa1.RemoveRange(all);
            db.SaveChanges();
            Goster();
            toplamFiyat();
        }
