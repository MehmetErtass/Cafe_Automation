...
{
    public partial class OdemeMasa3 : Form
    {
        List<tbl_Masa3> list;
        int fiyat = 0;
        public OdemeMasa3()
        ...
        private void sil()
        {
            var all = from c in db.tbl_Masa3 select c;
            db.tbl_Masa3.RemoveRange(all);
            db.SaveChanges();
            Goster();
            toplamFiyat();
        }
        ...
        private void OdemeMasa3_Load(object sender, EventArgs e)
        {
            Goster();
            toplamFiyat();
