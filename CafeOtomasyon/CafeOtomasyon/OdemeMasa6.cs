...
{
    public partial class OdemeMasa6 : Form
    {
        List<tbl_Masa6> list;
        int fiyat = 0;
        public OdemeMasa6()
        ...
        private void sil()
        {
            var all = from c in db.tbl_Masa6 select c;
            db.tbl_Masa6.RemoveRange(all);
            db.SaveChanges();
            Goster();
            toplamFiyat();
        }
        ...
        private void OdemeMasa6_Load(object sender, EventArgs e)
        {
            Goster();
            toplamFiyat();
